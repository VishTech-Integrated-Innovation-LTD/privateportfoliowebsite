const AboutSection = () => {
     const bio = `
    Folasade Adepoju holds a Bachelor of Arts degree in Library Science and Sociology from Bayero University, Kano, and a Master's Degree in Information Management from Ahmadu Bello University, Zaria.
    ...
    This work inspired deeper exploration into how cultural narratives can shape young minds. With a deep commitment to nurturing responsible future generations, Folasade uses the power of stories to foster empathy, awareness, and positive change in Nigerian children and beyond.
  `.trim();
